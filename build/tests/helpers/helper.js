...
const currency_dictionary_1 = require("../../src/lib/dictionary/currency-dictionary");
const WalletApi = require("../../src/lib/wallet/api/wallet-api");
const EosClient = require("../../src/lib/common/client/eos-client");
const BlockchainRegistry = require("../../src/lib/blockchain-registry");
const TransactionSender = require("../../src/lib/transaction-sender");
const ConfigService = require("../../src/config/config-service");
const EnvHelper = require("../../src/lib/helpers/env-helper");
const SmartContractsDictionary = require("../../src/lib/dictionary/smart-contracts-dictionary");
const resources = [
    'cpu', 'net', 'ram',
];
...
class Helper {
    ...
    static getTesterAccountBrainkey() {
    ...
    static initForEnvByProcessVariable() {
        const executors = {
            [EnvHelper.testEnv()]: () => {
    ...
    static checkUnstakingRequestIsEmpty(data) {
        ...
        expect(data.currency).toBe(currency_dictionary_1.UOS);
    }
    /**
     *
     * @param {Object} data
    ...
    static getAccountNameToSocialPrivateKey() {
     ...
     * @private
     */
    static checkUnstakingRequest(data, errorLabel) {
        // @ts-ignore

...
class TransactionSender {
  ...
  static async sellRamBytes(accountName, privateKey, bytesAmount) {
    ...
    return this._sendTransaction(privateKey, [ action ]);
  }
  ...
  static async claimEmission(accountName, actorPrivateKey) {
    ...
    return this._sendTransaction(actorPrivateKey, [ action ]);
  }
  ...
  static async sendTokens(accountNameFrom, privateKey, accountNameTo, amount, memo = '') {
    const stringAmount  = this._getUosAmountAsString(amount);
    const action        = this._getSendTokensAction(accountNameFrom, accountNameTo, stringAmount, memo);

    return this._sendTransaction(privateKey, [
      action
    ]);
  }
  ...
  static _getSellRamAction(accountName, amount) {
    ...
    return this._getSingleUserAction(accountName, smartContract, actionName, data);
  }
